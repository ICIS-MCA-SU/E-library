...
<style>
    ...
    .active55 a,.active54 a, .active52 a, .active51 a{
          ...
          <div class="row bkorder-row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 py-2 bkorder-img-row no-gutters" style="">
             ...
             <div class="col-lg-9 col-md-9 col-sm-12  bkorder-page">
               ...
               <br><strong>Description : </strong><?php echo strip_tags(substr($description,0,30)),'...';?></p>
               </div>
               <div class="col-lg-6 col-md-6 col-sm-6 col-12">
               <h3><strong>Reserve Now </strong></h3>
               <p><strong>Get the book on:</strong> <?php echo $availableDate?><br>
               ...
               <label style="display: none" id="accession" name="accession"><?php echo $accession?></label>
                                    ...
                                    <?php if(isset($_SESSION['user_id'])){
                                                ...
                                                if($hasOdered >= 1){
                             echo '<p style="color: red"> Your Have already made an Reservation for this book</p>';
                            } else{
                                ?>
                              <div>
                              <a href="" id="btnReserveBook" class="btnhold">Reserve Now</a>
                              </div>
                              <div class=" mt-4 mb-3">
