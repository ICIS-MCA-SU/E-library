...
<style>
    ...
    .active22 a,.active21 a,.active23 a,.active25 a{
...
<section id="physical-banner" class="d-flex flex-column justify-content-center align-items-center">
    ...
    <h1><strong>Srinivas University <br>Study Material</strong></h1>
...
<section id="breadcrumbs" class="breadcrumbs">
    <div class="container">
        <ol>
            ...
            <li style="cursor:text;">SU Study Material</li>
        </ol>
    </div>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (result === "3") {
                                ...
                                swal({
                                    title: "Success",
                                    text: "Study Meterial Added To Your Profile. Please go to profile to View",
                                    type: "success",
