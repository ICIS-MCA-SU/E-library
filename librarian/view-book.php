...
<div class="main-content row" x-data="getBooks">
                                    ...
                                    <form id="search-from" action="" method="post" name="search-form " enctype="multipart/form-data">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 col-12">
                                                <input class="btn btn-primary py-2" type="button" name="submit" id="btn" value="Search" x-on:click="getBookBySearch">
                                            </div>
                                            <div class="col-md-2 col-12 btnExportCol">
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    <button type="button" class="btn btn-primary" style="padding:10px 15px" x-on:click="reload">
                                            ...
                                            <tbody>
                                                <template x-for="item in booksJson" :key="item.book_id">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <template x-if="item.book_type!='physical book'?true:false">
                                                                <div>
                                                                    <div class="flex align-items-center list-user-action">
                                                                        <a data-toggle="tooltip" data-placement="top" title="" data-original-title="pdf" x-bind:href="'../books/pdf/'+item.pdf" target="_blank"><i class="fa fa-file-pdf" style="font-size: 1.5em;line-height:10px;"></i></a>
                                                                    </div>
                                                                </div>
                                                            </template>
                                                        ...
                                                        <td>
                                                            <div class="flex align-items-center list-user-action">
                                                                <a data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" x-bind:href="'edit-book.php?id='+item.book_id"><i class="fa fa-edit" style="font-size: 20px;"></i></a>
                                                                <a x-on:click="deleteBook(item.book_id)"><i class="fas fa-trash-alt btnDelete"></i></a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </template>
    ...
    $("#search-from").on('submit', function(e) {
        ...
        window.location.href = "view-book.php?keyword=" + keywords + "&department=" + department;
    });
</script> -->
