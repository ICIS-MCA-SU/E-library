    ...
    <div class="col">
        <div class="card pt-2">
            <div class="card-header">
                <h4 class="col-lg-9 col-md-9 col-12">Professor's Records</h4>
                <h4 class=" col-lg-3 col-md-3 col-12" style="text-align:end">Total Professor's:<?php $rows = (new dbhelper)->__getProfessorDetails();
                                                                                                echo count($rows) ?></h4>
            </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover mb-0" id="professorTable">
                        <thead>
                            <tr>
                                <th>#</th>
