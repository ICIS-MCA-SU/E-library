...
<style>
    ...
    .active22 a,.active23 a,.active24 a,.active25 a{
...
<section id="breadcrumbs" class="breadcrumbs">
    <div class="container">
        <ol>
            ...
            <li style="cursor:text;">E Book</li>
        </ol>
    </div>
                                ...
                                <div class="col-lg-5 col-md-5">
                                    <div class="form-row">
                                        <select name="catalog" id="catalog" class="form-control my-2">
                                            <option>Sort By Department/College</option>
            ...
            <template x-if="!isSearch&isVisble&totalPages>1">
                <div class="row">
                    <div class="col-12 justify-content-end" style="text-align:center;">
                        ...
                        <span x-text="currentPage" style="padding:10px"></span> -->
