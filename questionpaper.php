...
<style>
    ...
    .active22 a,.active21 a,.active24 a,.active23 a{
...
<section id="physical-banner" class="d-flex flex-column justify-content-center align-items-center">
    ...
    <div class="container" data-aos="fade-in">
        <h1><strong>Srinivas University <br>Question Paper</strong></h1>
...
<section id="breadcrumbs" class="breadcrumbs">
    <div class="container">
        <ol>
            ...
            <li style="cursor:text;">SU Question paper</li>
        </ol>
    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6 mb-3 d-flex align-items-stretch no-gutters">
                        <div class="card no-gutters member">
                            ...
                            <div class="card-body d-flex flex-column member-info">
                                ...
                                <strong>
                                    <h5 x-text="item.edition"></h5>
                                </strong>
                                <strong>
                                    <h5 x-text="item.author"></h5>
                                </strong>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (result === "3") {
                                ...
                                swal({
                                    title: "Success",
                                    text: "Question Paper Added To Your Profile. Please go to profile to View",
                                    type: "success",
